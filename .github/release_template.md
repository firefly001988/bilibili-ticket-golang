![Release Downloads](https://img.shields.io/github/downloads/firefly001988/bilibili-ticket-golang/VERSION/total?style=flat-square&color=blue)

> 基于 Wails v2 构建的跨平台桌面应用，用于 Bilibili 会员购抢票辅助。
> 本软件仅供学习、研究与技术交流使用。
...
| 平台 | 架构 | 下载 |
|------|------|------|
| Windows | amd64 | [bilibili-ticket-golang_windows_amd64_VERSION.tar.gz](https://github.com/firefly001988/bilibili-ticket-golang/releases/download/VERSION/bilibili-ticket-golang_windows_amd64_VERSION.tar.gz) |
| Windows | arm64 | [bilibili-ticket-golang_windows_arm64_VERSION.tar.gz](https://github.com/firefly001988/bilibili-ticket-golang/releases/download/VERSION/bilibili-ticket-golang_windows_arm64_VERSION.tar.gz) |
